...
<style>
   body {
    ...
    align-items: center;
    height: 800px;
    background-image: url('mercedesarkaplan.jpg');
...
<body>
    <div class='kutu'>
        <form action='#' method='POST' class='iletisim'>
            ...
            <div class='formlar'>
                <label for='deneyim'>Satın almak istediğiniz araçta bulunması gereken özellikler:</label>
                <input type='text' id='deneyim' name='deneyim' required>
            </div>
            <div class='formlar'>
                <label for='hiz'>Bütçeniz:</label>
...
?>
<?php
include("baglantisatinalmadeneyimi.php");
?>